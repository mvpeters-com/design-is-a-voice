...
export default function Home({ posters }: { posters: (Poster & { poster: Media })[] }) {
    ...
    return (
        <div className="flex flex-col justify-between min-h-dvh">
            ...
            <div className="h-[75px] md:h-auto flex flex-row flex-col w-full justify-between align-center p-6 md:p-10">
